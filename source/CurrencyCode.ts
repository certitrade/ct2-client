...
export namespace CurrencyCode {
	...
	export function from(currency: Currency): CurrencyCode | undefined {
		...
		switch (currency) {
			case "ALL": result = 8; break
			case "DZD": result = 12; break
			case "ARS": result = 32; break
			case "AUD": result = 36; break
			case "BSD": result = 44; break
			case "BHD": result = 48; break
			case "BDT": result = 50; break
			case "AMD": result = 51; break
			case "BBD": result = 52; break
			case "BMD": result = 60; break
			case "BTN": result = 64; break
			case "BOB": result = 68; break
			case "BWP": result = 72; break
			case "BZD": result = 84; break
			case "SBD": result = 90; break
			case "BND": result = 96; break
	...
	export function decimalDigits(currencyCode: CurrencyCode): number | undefined {
		...
		switch (currencyCode) {
			...
			case 32: result = 2; break
			case 36: result = 2; break
			case 44: result = 2; break
			case 48: result = 3; break
			case 50: result = 2; break
			case 51: result = 2; break
			case 52: result = 2; break
			case 60: result = 2; break
			case 64: result = 2; break
			case 68: result = 2; break
			case 72: result = 2; break
			case 84: result = 2; break
			case 90: result = 2; break
			case 96: result = 2; break
